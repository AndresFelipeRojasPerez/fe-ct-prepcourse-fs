...
describe('JAVASCRIPT II', function () {
   describe('obtenerMayor(x, y)', function () {
      xit('Debe retornar X si es mayor que Y', function () {
         expect(obtenerMayor(10, 5)).toBe(10);
      });
      xit('Debe retornar Y si es mayor que X', function () {
         expect(obtenerMayor(50, 100)).toBe(100);
      });
      xit('Si son iguales debe retornar cualquiera', function () {
         expect(obtenerMayor(1000, 1000)).toBe(1000);
      });
   });

   describe('mayoriaDeEdad(edad)', function () {
      xit("Debe retornar 'Allowed' si la edad es igual o mayor a 18", function () {
         expect(mayoriaDeEdad(18)).toBe('Allowed');
         expect(mayoriaDeEdad(35)).toBe('Allowed');
      });
      xit("Debe retornar 'Not allowed' si la edad es menor a 18", function () {
         expect(mayoriaDeEdad(7)).toBe('Not allowed');
      });
   });

   describe('conection(status)', function () {
      xit('Debe retornar "Online" si el status es 1', function () {
         expect(conection(1)).toBe('Online');
      });
      xit('Debe retornar "Away" si el status es 2', function () {
         expect(conection(2)).toBe('Away');
      });
      xit('Debe retornar "Offline" si el status es cualquier otro valor', function () {
         expect(conection(3)).toBe('Offline');
      });
   });

   describe('saludo(idioma)', function () {
      xit("Debe retornar 'Guten Tag!' por 'aleman'", function () {
         expect(saludo('aleman')).toBe('Guten Tag!');
      });
      xit("Debe retornar 'Hello!' por 'ingles'", function () {
         expect(saludo('ingles')).toBe('Hello!');
      });
      xit("Debe retornar 'Ni Hao!' por 'mandarin'", function () {
         expect(saludo('mandarin')).toBe('Ni Hao!');
      });
      xit("Debe retornar 'Hola!' si el argumento no se especificó", function () {
   ...
   describe('colors(color)', function () {
      xit("Debe retornar 'This is {color}'", function () {
      ...
      xit("Debe retornar 'Color not found' si el argumento no es el esperado", function () {
   ...
   describe('esDiezOCinco(num)', function () {
      xit('Debe retornar True si num es 10 o 5', function () {
         expect(esDiezOCinco(10)).toBe(true);
         expect(esDiezOCinco(5)).toBe(true);
      });
      xit('Debe retornar False si num no es 10 o 5', function () {
   ...
   describe('estaEnRango(num)', function () {
      xit('Debe retornar True si num está en el rango', function () {
      ...
      xit('Debe retornar False si num está fuera de rango', function () {
   ...
   describe('esEntero(num)', function () {
      xit('Debe retornar False si num no es entero', function () {
         expect(esEntero(0.5)).toBe(false);
      });
      xit('Debe retornar True si num es un entero positivo', function () {
         expect(esEntero(5)).toBe(true);
      });
      xit('Debe retornar True si num es un entero negativo', function () {
         expect(esEntero(-20)).toBe(true);
      });
      xit('Debe retornar True si el argumento es cero', function () {
